...
//    }
    ...
    protected void configure(HttpSecurity http) throws Exception{
        http
                ...
                .antMatchers("/aplikasi/form").hasAuthority("RILIS_APLIKASI")
//                .antMatchers("/bug/proses").hasAuthority("ASSIGNMENT_BUG")
//                .antMatchers("/bug/report").hasAuthority("REPORT")
//                .antMatchers("/bug/form").hasAuthority("MAKE_ISSUE")
                .antMatchers("/versi/form").hasAuthority("RILIS_VERSI")
//                .antMatchers("/bug/solve").hasAuthority("SOLVE_BUG")
